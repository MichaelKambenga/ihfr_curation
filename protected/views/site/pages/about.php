...
<p>
To request an update to a facility, first search for the facility <?php echo TbHtml::link('here',$this->createUrl('curation/facility'), array('class'=>'btn btn-inverse'))?>
</p>
<p>
