...
class FaqsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if (isset($_POST['Faqs'])) {
			$model->attributes=$_POST['Faqs'];
                        $uploadFile = CUploadedFile::getInstance($model, 'attachment');
                        $fileName = "{$uploadFile}";
                        $model->attachment = $fileName;
			if ($model->save()) {
                          if(isset($uploadFile)){                       
                            $uploadFile->saveAs(Yii::app()->basePath.'/../userfiles/faq_attachments/'.$fileName);
                            }
	...
	{
		$dataProvider=new CActiveDataProvider('Faqs');
