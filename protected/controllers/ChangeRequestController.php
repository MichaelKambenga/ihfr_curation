...
class ChangeRequestController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['ChangeRequest'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('ChangeRequest');
	...
	{
		$model=ChangeRequest::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param ChangeRequest $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='change-request-form')
		{
